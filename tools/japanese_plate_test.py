...
Specially designed to detect Japanese license plates like " 337 BR45IL"
"""
...
def create_japanese_plate_patterns():
    ...
    test_plates = [
        " 337 BR45IL",  # Your example
        " 123 4567",  # Tokyo plate
        " 456 8901",  # Osaka plate
        " 789 2345",  # Shinagawa plate
        " 321 6789",  # Yokohama plate
        "123-456",         # Simple format
        "ABC 123",         # English format
        "1234",         # Japanese numbers only
    ]
